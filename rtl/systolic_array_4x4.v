module systolic_array_4x4 (
    ...
    wire signed [7:0] unused_a, unused_w;
    ...
    systolic_pe p03(.clk(clk),.rst(rst),.en(en),.a_in(a03),.w_in(w3_in),.a_out(unused_a),.w_out(w13),.acc(y03));
    ...
    systolic_pe p13(.clk(clk),.rst(rst),.en(en),.a_in(a13),.w_in(w13),.a_out(unused_a),.w_out(w23),.acc(y13));
    ...
    systolic_pe p23(.clk(clk),.rst(rst),.en(en),.a_in(a23),.w_in(w23),.a_out(unused_a),.w_out(w33),.acc(y23));

    systolic_pe p30(.clk(clk),.rst(rst),.en(en),.a_in(a3_in),.w_in(w30),.a_out(a31),.w_out(unused_w),.acc(y30));
    systolic_pe p31(.clk(clk),.rst(rst),.en(en),.a_in(a31),.w_in(w31),.a_out(a32),.w_out(unused_w),.acc(y31));
    systolic_pe p32(.clk(clk),.rst(rst),.en(en),.a_in(a32),.w_in(w32),.a_out(a33),.w_out(unused_w),.acc(y32));
    systolic_pe p33(.clk(clk),.rst(rst),.en(en),.a_in(a33),.w_in(w33),.a_out(unused_a),.w_out(unused_w),.acc(y33));
endmodule
